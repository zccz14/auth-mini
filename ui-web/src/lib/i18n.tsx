...
export const en = {
  ...
  'common.ed25519PublicKey': 'ED25519 public key — register and share this value',
  'common.ed25519PrivateSeed': 'ED25519 private key seed — keep secret',
  'common.publicKeyHint': 'Base64url-encoded 32-byte public key. Auth Mini registers only this value.',
  'common.privateSeedWarning': 'Never send or paste this seed into an untrusted app. Save it in a password manager or secure key store. Auth Mini never receives it.',
  'common.copyPublicKey': 'Copy public key',
  'common.copyPrivateSeed': 'Copy private seed',
...
export const zhCN: Record<TranslationKey, string> = {
  ...
  'common.ed25519PrivateSeed': 'ED25519 私钥种子 — 必须保密',
  'common.publicKeyHint': 'base64url 编码的 32 字节公钥。Auth Mini 只会注册此值。',
  'common.privateSeedWarning': '切勿发送给服务端或粘贴到不受信任的应用。请保存到密码管理器或安全密钥存储。Auth Mini 永远不会接收它。',
  'common.copyPublicKey': '复制公钥',
  'common.copyPrivateSeed': '复制私钥种子',
  'common.copied': '已复制',
