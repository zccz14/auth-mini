...
- 2026-04-04: Task 1 已完成并通过 spec/code review；当前实现补齐了全局 CORS middleware、allowed/disallowed origin、preflight、error-path 与 `Vary: Origin` 行为，下一步进入 SDK endpoint 契约更新。
...
- 提交 Task 1 的 Server CORS 切片。
- 然后进入 Task 2：SDK endpoint 契约与测试更新。
