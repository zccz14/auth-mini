...
describe('LoginRoute', () => {
  ...
  it('adopts ED25519 tokens locally and redirects with a JWT', async () => {
    const user = userEvent.setup();
  ...
  it('blocks login when redirect_uri is missing', () => {
    renderLogin('/login');

    expect(screen.getByText('redirect_uri is required.')).toBeInTheDocument();
    expect(
