---
description: "Use this skill when creating, modifying, explaining, diagnosing, or validating a model, rule, scoring system, prediction, parameter choice, mechanism hypothesis, or research conclusion. It evaluates reliability by requiring both prior rationale and empirical validation, and by separating reliable conclusions from black-box correlations, empty stories, post-hoc leads, and unreliable claims."
---
# Reliable Model
